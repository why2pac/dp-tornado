...
class MultiplePkSchema(dpTable):
    ...
    primary = dpAttribute.field(dpAttribute.DataType.BIGINT, m_pk=True, comment='Primary')
    tertiary = dpAttribute.field(dpAttribute.DataType.BIGINT, m_pk=True, comment='Tertiary')
    secondary = dpAttribute.field(dpAttribute.DataType.BIGINT, m_pk=True, comment='Secondary')
