...
def run_debug():
    assert_output(['dp4p', 'run', '__cli_test__/app_dir', '--identifier', consts.dp_testing_identifier, '--port', consts.dp_testing_port, '--ini', 'config.ini', '--dryrun', 'yes', '--debug', 'yes'], 'Server Mode : Debugging (debug)')


def run_production():
    assert_output(['dp4p', 'run', '__cli_test__/app_dir', '--identifier', consts.dp_testing_identifier, '--port', consts.dp_testing_port, '--ini', 'config.prod.ini', '--dryrun', 'yes'], 'Server Mode : Production (production)')
